  ...
  return (
    <section className='max-w-[1450px] mx-auto py-[50px] grid md:grid-cols-[40%_55%] sm:grid-cols-1 md:gap-0 gap-10 items-center justify-between lg:px-0 md:px-5 px-2'>
        <div>
            ...
            <p className='lg:text-[25px] text-[20px] font-semibold leading-9 mb-6 text-[#666]'>Born in India, we are grounded on innovation, our community, and respecting the planet we all call home.</p>
