    ...
    <section className='bg-[#F9F9F9] w-full py-[50px]'>
        ...
        <div className='grid lg:grid-cols-2 grid-cols-1'>
            <div className='lg:order-1 order-2 lg:px-12 lg:pt-28 p-5 bg-white'>
              ...
              <span className='text-[12px] basis-[50%] font-medium text-[#666]'>Based on 99+ reviews</span>
              </div>
            ...
            <div className='lg:order-2 order-1'>
                <img className='w-full h-full object-cover' src="images/WR.jpg" alt="" />
            </div>
        </div>
        <div className='grid lg:grid-cols-2 grid-cols-1'>
            <div className='lg:order-1 order-2 lg:px-12 lg:pt-28 p-5 bg-white'>
            ...
            <div className='lg:order-2 order-1'>
                <img className='w-full h-full object-cover' src="images/MR.jpg" alt="" />
            </div>
        </div>
        </div>
    </section>
