    ...
    <footer className='w-full py-[50px] bg-black text-white px-5'>
      <div className='max-w-[1400px] mx-auto w-full'>
        ...
        <ul className='grid md:grid-cols-4 grid-cols-2 items-center md:gap-0 gap-5 justify-around'>
            ...
            <li className='flex flex-col text-center sm:gap-3 gap-2'>
                <img className='lg:w-14 w-8 mx-auto' src="/images/ArowaiF.jpg" alt="" />
                <div className='md:text-[20px] text-[15px] font-medium'>Arowai&apos;s Club</div>
        ...
        <div className='grid lg:grid-cols-[15%_55%_25%] grid-cols-1 justify-between py-24'>
          <div className='lg:order-1 order-2'>
            <img className='lg:w-full w-[30%] lg:mx-0 mx-auto lg:py-0 py-4 ' src="/images/Arowai.jpg" alt="" />
            ...
            <div className='lg:grid hidden grid-cols-3 lg:order-2 order-3'>
              ...
              <ul className='space-y-2.5 mx-auto'>
                ...
                <li className='text-[13px] font-medium cursor-pointer'>Arowai Club</li>
        ...
        <div className='flex md:flex-row flex-col items-center justify-between'>
          <h6 className='text-[12px] font-medium'>© Arowai Streetwear 2025 , All Rights Reserved.</h6>
          <h6 className='text-[12px] font-medium'>Created with 💖 by Sukh Jangid</h6>
        </div>
        </div>
    </footer>
  )
